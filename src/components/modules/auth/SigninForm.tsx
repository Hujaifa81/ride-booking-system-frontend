          ...
          <CardContent className="relative z-10">
            <div className="grid gap-6">
              ...
              <div className="flex flex-col gap-3">
                <Button
                  variant="outline"
                  className="w-full flex items-center gap-2 rounded-lg bg-white/10 text-white border border-white/20 hover:bg-white/20 transition"
                >
              ...
              <div className="relative text-center text-sm">
                <span className="px-2 relative z-10 text-gray-400">Or continue with</span>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-4">
                  ...
                  <Button
                    type="submit"
                    className="w-full flex items-center gap-2 bg-gradient-to-r from-purple-500 to-indigo-500 hover:opacity-90 cursor-pointer hover:bg-white/20 transition"
                  >
