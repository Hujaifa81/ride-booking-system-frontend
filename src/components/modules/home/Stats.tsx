  ...
  return (
    <section
      className="relative py-16 
        ...
        dark:bg-gradient-to-br dark:from-gray-800 dark:via-gray-900 dark:to-gray-950
        text-white overflow-hidden transition-colors duration-500"
    >
      {/* Decorative curved shape */}
      <div className="absolute -top-10 left-0 w-full h-20 bg-white dark:bg-gray-900 rounded-b-[50%] transition-colors duration-500"></div>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <div
                ...
                "
              >
                <div className="bg-white/20 dark:bg-gray-700/50 p-3 rounded-full transition-colors duration-300">
                  <Icon className="h-6 w-6 text-white dark:text-gray-100" />
                </div>
                <p className="text-3xl md:text-4xl font-bold text-white dark:text-gray-100">
                  {stat.value}
                </p>
